...
public class StageConstructor {
    ...
    public  static void generateAllStages(QuestConstructor quest, CharacterCreator character, StageConstructor stage, EnemyHumanCreator enemy) throws IOException {
        ...
        int[][] stagesPoints = Formulas.calculateStagesPoints(quest, stagesStructure[0]);
    ...
    public  static void generateStageFilling (CharacterCreator character, QuestConstructor quest, StageConstructor stage,
                                               EnemyHumanCreator enemy){
        int enemiesPointsLeft = 0;
