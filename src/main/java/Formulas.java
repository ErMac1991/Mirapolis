...
public abstract class Formulas {
    ...
    public static void calculateQuestValues(QuestConstructor quest) {
        ...
        if (quest.getQuestLevel() >= 1 && quest.getQuestLevel() <= 3) {
            ...
            quest.setStagesInQuest(randomNumber.nextInt(1) + 2);  // количество этапов в квесте,
            ...
            quest.setStagesInQuest(randomNumber.nextInt(3) + 3);  // количество этапов в квесте,
            System.out.println("Количество этапов в квесте: " + quest.getStagesInQuest());
            questPricesCalculate(quest);
            ...
            quest.setStagesInQuest(randomNumber.nextInt(3) + 4);  // количество этапов в квесте,
            System.out.println("Количество этапов в квесте: " + quest.getStagesInQuest());
            questPricesCalculate(quest);
            ...
            quest.setStagesInQuest(randomNumber.nextInt(2) + 5);  // количество этапов в квесте,
            System.out.println("Количество этапов в квесте: " + quest.getStagesInQuest());
            questPricesCalculate(quest);
            ...
            quest.setStagesInQuest(randomNumber.nextInt(2) + 6);  // количество этапов в квесте,
            System.out.println("Количество этапов в квесте: " + quest.getStagesInQuest());
            questPricesCalculate(quest);
            ...
            quest.setStagesInQuest(randomNumber.nextInt(1) + 7);  // количество этапов в квесте,
            System.out.println("Количество этапов в квесте: " + quest.getStagesInQuest());
            questPricesCalculate(quest);
        } else {
    ...
    public static void questPricesCalculate(QuestConstructor quest) {
        ...
        quest.setRoyalty(quest.getDeposit() +
                ...
                randomNumber.nextInt(50) * quest.getDifficultyRatio());// вознаграждение за прохождение квеста
